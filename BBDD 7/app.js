...
//9 - establecer las rutas    -------------------------------------------------- Todas estas rutas son modificadas en el punto 12, 12B y 12C
// app.get('/', (req,res)=>{
//     //res.send('Hola mundo') //por si queremos hacer una prueba en pantalla
//     res.render('index', {msg:'Moi'});
// })
// app.get('/login', (req,res)=>{
//     res.render('login');
// })
// app.get('/registro', (req,res)=>{
//     res.render('register', {msg:'Moi'});
// })
